...
CREATE TABLE IF NOT EXISTS "level" (
  ...
  -- afin d'utiliser la génération automatique d'un identifiant on utilise une colonne de type serial 
  
  -- (Attention désormais on utilisera plutôt GENERATED ALWAYS AS IDENTITY : https://wiki.postgresql.org/wiki/Don't_Do_This#Don.27t_use_serial
  ...
  -- faisant référence à la sequence nommé level_id_seq
  -- mais tout cela est automatique à la création (ouf !)
